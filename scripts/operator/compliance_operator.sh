...
#sed -i "s|compliance_directory:.*$|compliance_directory: ${COMPLIANCE_DIRECTORY}|g" ocp_compliance_vars.yaml
...
#sed -i "s|compliance_upgrade_channel:.*$|compliance_upgrade_channel: ${COMPLIANCE_UPGRADE_CHANNEL}|g" ocp_compliance_vars.yaml
sed -i "s|compliance_e2e:.*$|compliance_e2e: true|g" ocp_compliance_vars.yaml
sed -i "s|compliance_e2e_github_repo:.*$|compliance_e2e_github_repo: https://github.com/AniruddhaNayek/openshift-tests-private.git|g" ocp_compliance_vars.yaml
